...
==================================================
  Rows: 15,122,182  Columns: 6
  Profiling 6 columns...
  Validating primary key...
  PK nconst: VALID
  Analyzing multi-value columns: ['primaryProfession', 'knownForTitles']
  primaryProfession: 46 distinct, avg 1.39 per row, max 3 per row
  knownForTitles: 2,210,851 distinct, avg 1.84 per row, max 4 per row
  Done: name_basics

==================================================
Processing: title_basics
==================================================
  Rows: 12,323,467  Columns: 9
  Profiling 9 columns...
  Validating primary key...
  PK tconst: VALID
  Analyzing multi-value columns: ['genres']
  genres: 28 distinct, avg 1.63 per row, max 3 per row
  Done: title_basics

==================================================
Processing: title_akas
==================================================
  Rows: 55,294,765  Columns: 8
  Profiling 8 columns...
  Validating primary key...
  PK ['titleId', 'ordering']: VALID
  Done: title_akas

==================================================
Processing: title_crew
==================================================
  Rows: 12,325,801  Columns: 3
  Profiling 3 columns...
  Validating primary key...
  PK tconst: VALID
  Analyzing multi-value columns: ['directors', 'writers']
  directors: 882,095 distinct, avg 1.34 per row, max 528 per row
  writers: 1,122,941 distinct, avg 2.33 per row, max 1393 per row
  Done: title_crew

==================================================
Processing: title_episode
==================================================
  Rows: 9,514,619  Columns: 4
  Profiling 4 columns...
  Validating primary key...
  PK tconst: VALID
  Done: title_episode
...
==================================================
  Rows: 98,073,271  Columns: 6
  Profiling 6 columns...
  Validating primary key...
  PK ['tconst', 'ordering']: VALID
  Done: title_principals

==================================================
Processing: title_ratings
==================================================
  Rows: 1,641,397  Columns: 3
  Profiling 3 columns...
  Validating primary key...
  PK tconst: VALID
  Done: title_ratings
...
|---|---------|------|------|---------|-------------|
| 1 | `name_basics` | `name.basics.tsv.gz` | 15,122,182 | 6 | Cast & crew personnel details |
| 2 | `title_basics` | `title.basics.tsv.gz` | 12,323,467 | 9 | Title metadata and genres |
| 3 | `title_akas` | `title.akas.tsv.gz` | 55,294,765 | 8 | Localized title names (multi-language/region) |
| 4 | `title_crew` | `title.crew.tsv.gz` | 12,325,801 | 3 | Directors and writers per title |
| 5 | `title_episode` | `title.episode.tsv.gz` | 9,514,619 | 4 | Series to episode relationships |
| 6 | `title_principals` | `title.principals.tsv.gz` | 98,073,271 | 6 | Principal cast/crew credits per title |
| 7 | `title_ratings` | `title.ratings.tsv.gz` | 1,641,397 | 3 | Average ratings and vote counts |
...
| `primaryName` | 66 | 0.0% | 11,536,668 | 76.29% | False | Fred Astaire, Lauren Bacall, Brigitte Bardot |
...
| `primaryTitle` | 0 | 0.0% | 5,514,252 | 44.75% | False | Carmencita, Le clown et ses chiens, Poor Pierrot |
| `originalTitle` | 0 | 0.0% | 5,541,674 | 44.97% | False | Carmencita, Le clown et ses chiens, Pauvre Pierrot |
...
| `title` | 0 | 0.0% | 7,802,439 | 14.11% | False | Carmencita, Carmencita, Carmencita |
| `region` | 12,403,683 | 22.43% | 251 | 0.0% | False | DE, US, HU |
...
|---------|----------|-------|---------------|
| `\N` used as null marker across all files | Replace with proper NULL on load | Bronze/Silver | IMDb convention; nullValue option handles this |
...
Wrote 10866 bytes.
Saved: /Volumes/workspace/imdb_final_project/raw_data/profiling_summary.md
Saved: imdb_final_project.profiling_row_counts
Use this table to validate Bronze row counts after ingestion.